export async function getRestaurants(url,setResCtx) {
    ...
    const restaurants = (responseData?.data?.cards[4]?.card?.card?.gridElements?.infoWithStyle?.restaurants)||(responseData?.data?.cards[2]?.card?.card?.gridElements?.infoWithStyle?.restaurants);
